...
- Rebuilt the login/create-account page with Proofly branding, magic-link auth for sign-in and sign-up, trade-aware messaging, and CTA styling aligned to the `--action` green.
