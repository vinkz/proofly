...
## Step 2 Evidence Fields (Structured)
- Appliance photo: boiler_make, boiler_model, boiler_type, mount_type, location, gas_type, serial_number
- Serial/Label: serial_number, gas_type, manufacture_year
- Flue photo: flue_type, termination, condition
- Meter reading: meter_reading, unit, meter_location
- Ventilation: ventilation_present, condition, notes
- Issue/Defect: defect_present, classification, notes

Demo autofill populates these fields with the same values listed in this spec (see demo section).
