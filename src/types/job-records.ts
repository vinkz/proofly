export const JOB_TYPES = ['safety_check', 'service', 'safety_check_service', 'breakdown', 'installation', 'warning_notice', 'general'] as const;
export type JobType = (typeof JOB_TYPES)[number];
export const DEFAULT_JOB_TYPE: JobType = 'general';
export const JOB_TYPE_LABELS: Record<JobType, string> = {
  safety_check: 'Landlord safety check',
  service: 'Service',
  safety_check_service: 'Safety check + service',
  breakdown: 'Breakdown',
