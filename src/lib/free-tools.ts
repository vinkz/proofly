...
export const FREE_TOOLS: FreeTool[] = [
  {
    ...
    name: 'CP12 generator',
    blurb: 'Create a complete Landlord Gas Safety Record PDF for any gas appliance.',
  ...
  },
  {
    ...
    blurb: 'Create a gas appliance service record PDF.',
  ...
  },
  {
    ...
    blurb: 'Calculate heat input from a metric or imperial timed meter test.',
    effort: 'Instant',
