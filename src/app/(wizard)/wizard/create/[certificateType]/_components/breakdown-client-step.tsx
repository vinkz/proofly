        ...
        <div className="rounded-[12px] border-[0.5px] border-[var(--color-border-tertiary)] bg-[var(--color-background-primary)] p-4">
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <AddressAutocompleteField
              ...
              onValueChange={(value) => setBreakdownInfo((prev) => ({ ...prev, property_address: value }))}
              onAddressSelect={(address) => setBreakdownInfo((prev) => ({ ...prev, postcode: address.postcode || prev.postcode }))}
