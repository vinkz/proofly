...
const RequiredSchema = Step1Schema.merge(Step2Schema).merge(Step3Schema).merge(Step5Schema);
...
export function CommissioningWizard({ jobId, initialFields, initialJobContext = null, stepOffset = 0 }: CommissioningWizardProps) {
  ...
  return (
    <>
      {step === 1 ? (
        <WizardLayout step={offsetStep(1)} total={totalSteps} title="Company + engineer" status="Commissioning">
          {demoEnabled ? (
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Confirm installer details and Gas Safe registration.</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                <Input
                  ...
                  placeholder="Company address line 1 (optional)"
                ...
                />
                <Input
                  value={fields.company_address_city}
                  onChange={(e) => setFields((prev) => ({ ...prev, company_address_city: e.target.value }))}
      ...
      {step === 2 ? (
        <WizardLayout step={offsetStep(2)} total={totalSteps} title="Job + client" status="Commissioning" onBack={() => setStep(1)}>
          {demoEnabled ? (
            <div className="mb-3 flex justify-end">
              <Button type="button" variant="outline" className="rounded-full text-xs" onClick={handleDemoFill} disabled={isPending}>
                Fill demo Commissioning
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Confirm the address and client details.</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid gap-3 sm:grid-cols-2">
                <Input
                ...
                <Input
                  ...
                  placeholder="Client address line 1 (optional)"
                  className="sm:col-span-2"
                />
                <Input
                ...
                />
                <Input
                  value={fields.client_address_city}
                  onChange={(e) => setFields((prev) => ({ ...prev, client_address_city: e.target.value }))}
                  placeholder="Town/City (optional)"
                />
                <Input
      ...
      {step === 3 ? (
        <WizardLayout step={offsetStep(3)} total={totalSteps} title="Appliance details" status="Commissioning" onBack={() => setStep(2)}>
          {demoEnabled ? (
            <div className="mb-3 flex justify-end">
              <Button type="button" variant="outline" className="rounded-full text-xs" onClick={handleDemoFill} disabled={isPending}>
                Fill demo Commissioning
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Capture boiler and flue information.</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      {step === 4 ? (
        <WizardLayout step={offsetStep(4)} total={totalSteps} title="Safety + gas checks" status="Commissioning" onBack={() => setStep(3)}>
          {demoEnabled ? (
            <div className="mb-3 flex justify-end">
              <Button type="button" variant="outline" className="rounded-full text-xs" onClick={handleDemoFill} disabled={isPending}>
                Fill demo Commissioning
          ...
          <Card>
            <CardHeader>
              <CardTitle>Safety + combustion</CardTitle>
              <CardDescription>Record combustion readings, gas pressures, and checks.</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid gap-3 sm:grid-cols-2">
      ...
      {step === 5 ? (
        <WizardLayout step={offsetStep(5)} total={totalSteps} title="Comments + sign-off" status="Commissioning" onBack={() => setStep(4)}>
          {demoEnabled ? (
            <div className="mb-3 flex justify-end">
              <Button type="button" variant="outline" className="rounded-full text-xs" onClick={handleDemoFill} disabled={isPending}>
                Fill demo Commissioning
          ...
          <Card>
            <CardHeader>
              <CardTitle>Comments + sign-off</CardTitle>
              <CardDescription>Capture commissioning comments and printed names.</CardDescription>
            </CardHeader>
            <CardContent>
