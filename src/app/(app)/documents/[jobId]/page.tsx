...
export default async function DocumentPage({ params }: { params: Promise<{ jobId: string }> }) {
  ...
  return (
    <div className="space-y-6 p-4">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-3xl font-semibold">Document for {state.job.client_name ?? 'Client'}</h1>
